...
scene.fog=new THREE.Fog(0x9fc2da,260,780);

const camera=new THREE.PerspectiveCamera(60,innerWidth/innerHeight,.1,1050);
...
const vehicles={
  moto:{
    ...
    steerLow:.64,steerHigh:.26,steerFadeStart:5.0,steerFadeEnd:18.0,
    steerResponse:8.5,steerState:0,wheelBase:1.42,
